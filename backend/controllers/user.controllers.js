...
import generateTokenAndSetCookie from "../utils/utilsConn.js";
...
export async function register(req, res) {
  try {
    ...
    // Email configuration
    const mailOptions = {
      from: "BudgetMitra <support@merocv.com>",
      to: savedUser.email,
      ...
      html: ` <html>
          ...
          <body>
            <div class="container">
              <h1>Welcome to Budget-Mitra!</h1>
              <p>Your account has been successfully created. You can now log in and start using our services.</p>
              <p>To get started, Track your income, expenses, and budget all in one place:</p>
              <ol>
