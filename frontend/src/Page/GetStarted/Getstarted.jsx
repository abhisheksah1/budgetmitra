      ...
      >
        ...
        <ul className="mt-2 ">
          {[
            ...
            { to: "income", icon: <HandCoins />, text: "Income" },
            { to: "budget", icon: <Bitcoin />, text: "Budget" },
            {
              to: "expenses",
              icon: <TrendingDown />,
              text: "Expenses",
            },
            { to: "investment", icon: <TrendingUp />, text: "Investment" },
