      ...
      <section className="bg-gray-100 px-4 md:px-16 py-12">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex-shrink-0 text-6xl text-blue-500 mb-4 md:mb-0">
                <SiSimplelogin />
              </div>
            ...
            <motion.div
              ...
              className="flex flex-col md:flex-row items-center border shadow-sm rounded-lg px-6 py-5"
            >
              <div className="flex-shrink-0 text-5xl text-blue-500 rounded-full p-4 mb-4 md:mb-0">
            ...
            <motion.div
              ...
              className="flex flex-col md:flex-row items-center border shadow-sm rounded-lg px-6 py-5"
            >
              <div className="flex-shrink-0 text-6xl text-blue-500 rounded-full p-4 mb-4 md:mb-0">
