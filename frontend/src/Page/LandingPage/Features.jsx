...
function Features() {
  return (
    <section className=" bg-blue-50 px-16 min-h-full">
      <div className="container  mx-auto px-6">
        <motion.h2
          initial={{ scale: 0, opacity: 0 }}
          whileInView={{ scale: 1, opacity: 1 }}
          transition={{ duration: 1 }}
          className="text-2xl md:text-3xl  py-10 lg:text-4xl font-bold text-blue-500  text-wrap text-center"
        >
          Features
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between w-full">
              ...
              <div className="flex justify-center sm:justify-end">
                <img
                  src={BudgetTracking}
                  alt="Budget Tracking"
                  className="mx-auto lg:max-w-56 max-w-48"
                />
              </div>
            </div>
          ...
          >
            <div className="flex flex-col sm:flex-row items-center justify-between w-full">
              <div className="text-center sm:text-left sm:mb-0 sm:mr-5">
                <h3 className="text-xl lg:mt-10 font-bold  sm:mb-4">
                  Expense Management
                </h3>
                <p className="text-gray-600">
        ...
        <div className="flex flex-col lg:flex-row justify-between  mt-24">
          ...
          <div className="lg:w-2/3 grid grid-cols-1 mb-10 md:grid-cols-2 gap-12">
            <motion.div
              initial={{ scale: 0, opacity: 0 }}
              whileInView={{ scale: 1, opacity: 1 }}
              transition={{ duration: 1 }}
              className=" border px-10 py-5 shadow-md rounded-lg flex flex-col  "
            >
